...
WORKS = [
    ...
    dict(slug="c1-riviera", title="Salt and Silk", film="riviera",
         ...
         it=dict(meta="Resort e swimwear · 2026",
         ...
         en=dict(meta="Resort & swimwear · 2026",
...
IT = dict(
    ...
    p_work="Immagini e film nella stessa produzione. Una selezione tra campagne realizzate per clienti e studi di concept prodotti in autonomia: per riservatezza i marchi non vengono nominati. Mostrano fino a dove arriva il metodo quando il brief lo permette.",
    status="Marchio riservato", film_lbl="Il film della campagna",
    ...
    proof_note="Prove di metodo realizzate da immagini pubbliche dei prodotti, per mostrare il processo: i marchi non vengono nominati.",
    s_motion="03 — Motion", h_motion="Ogni campagna si muove",
    p_motion="Il film non è un progetto separato con un budget separato: nasce dallo stesso mondo delle immagini, nella stessa produzione. Formati verticali per social e punto vendita. Anche qui una selezione tra lavori per clienti e studi di concept, senza nomi.",
    ...
    legal="Le campagne e i film mostrati sono una selezione tra lavori realizzati per clienti e studi di concept prodotti in autonomia: per riservatezza i marchi non vengono nominati. Le prove del metodo partono da immagini pubbliche dei prodotti, per mostrare il processo.",
)
...
EN = dict(
    ...
    p_work="Stills and film in the same production. A selection of campaigns made for clients and self-produced concept studies: for confidentiality, brands are not named. They show how far the method goes when the brief allows it.",
    status="Brand withheld", film_lbl="The campaign film",
    ...
    proof_note="Method proofs made from public product images, to show the process: brands are not named.",
    s_motion="03 — Motion", h_motion="Every campaign moves",
    p_motion="The film is not a separate project with a separate budget: it comes from the same world as the stills, in the same production. Vertical formats for social and retail. Here too, a selection of client work and concept studies, unnamed.",
    ...
    legal="The campaigns and films shown are a selection of work made for clients and self-produced concept studies: for confidentiality, brands are not named. The method proofs start from public product images, to show the process.",
)
